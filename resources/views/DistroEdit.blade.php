...
<html lang="en">
    ...
    <body class="bg-[#1e1e2e] font-sans antialiased">
        <div class="p-6 text-[#4c4f69]">
            <h1 class="text-3xl font-bold mb-6 text-[#04a5e5]">Edit Linux Distribution</h1>
            ...
            <form action="{{ route('update-distro', ['id' => $distro->id]) }}" method="POST" class="space-y-4">
                @csrf

                <div>
                    <label for="name" class="block text-sm font-medium text-[#89b4fa] mb-1">Distribution Name</label>
                    <input type="text" id="name" name="name" value="{{ $distro->name }}"
                ...
                <div>
                    ...
                    <input type="text" id="version" name="version" value="{{ $distro->version }}"
                        class="w-full px-4 py-2 rounded border border-gray-300 bg-[#1e1e2e] text-[#cdd6f4] focus:outline-none focus:ring-2 focus:ring-[#89dceb]">
                </div>

                <div>
                    <label for="package_manager" class="block text-sm font-medium text-[#89b4fa] mb-1">Package Manager</label>
                    <input type="text" id="package_manager" name="package_manager" value="{{ $distro->package_manager }}"
                        class="w-full px-4 py-2 rounded border border-gray-300 bg-[#1e1e2e] text-[#cdd6f4] focus:outline-none focus:ring-2 focus:ring-[#89dceb]">
                </div>

                <div>
                    <label for="home_url" class="block text-sm font-medium text-[#89b4fa] mb-1">Home URL</label>
                    <input type="text" id="home_url" name="home_url" value="{{ $distro->home_url }}"
                        class="w-full px-4 py-2 rounded border border-gray-300 bg-[#1e1e2e] text-[#cdd6f4] focus:outline-none focus:ring-2 focus:ring-[#89dceb]">
                </div>
